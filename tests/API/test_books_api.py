...
@pytest.allure.feature('Books API')
class TestBookApi(TestBase):
    ...
    @pytest.allure.step('01 - Check API status')
    ...
    @pytest.allure.step('02 - Check all fields present')
    ...
    @pytest.allure.step('03 - Check all fields have correct format')
